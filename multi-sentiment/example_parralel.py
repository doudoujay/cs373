...
if __name__ == '__main__':
    ...
    sampleSolu = pd.read_csv("sample_solu.csv")
    X_train, y_train = trainData.as_matrix()[:,1], trainData.as_matrix()[:,2],
    X_test = testData.as_matrix()[:,1]
    y_test = sampleSolu.as_matrix()[:,1]
